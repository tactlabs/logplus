...
class LogCapture:
    ...
    Generally you should use `logplus.testing.capture_logs`,
    but you can use this class if you want to capture logs with other patterns.

    :ivar List[logplus.typing.EventDict] entries: The captured log entries.
...
class ReturnLogger:
    ...
    >>> from logplus import ReturnLogger
...
class ReturnLoggerFactory:
    ...
    To be used with `logplus.configure`\ 's *logger_factory*.
