...
"""
Helpers that make development with *logplus* more pleasant.
    ...
    *after* the log line. If Rich_ or better-exceptions_ are present, in colors
    ...
    Args:
        ...
        event_key:
            ...
            e.g. using `logplus.processors.EventRenamer`. Ignored if
            *columns* are passed.

        timestamp_key:
            The key to look for timestamp of the log message. Needed when you
            rename it e.g. using `logplus.processors.EventRenamer`. Ignored
    ...
    .. versionchanged:: 21.2.0
       ...
       **not** use the `logplus.processors.format_exc_info` processor
    ...
    def get_default_level_styles(colors: bool = True) -> Any:
        ...
        home-grown :func:`~logplus.stdlib.add_log_level` you could do::
