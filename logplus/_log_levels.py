...
def add_log_level(
    ...
    logging as well. Therefore it's importable both from `logplus.processors`
    as well as from `logplus.stdlib`.

    .. versionadded:: 15.0.0
    .. versionchanged:: 20.2.0
       Importable from `logplus.processors` (additionally to
       `logplus.stdlib`).
