...
"""
logplus's native high-performance loggers.
"""
...
def make_filtering_bound_logger(min_level: int) -> type[FilteringBoundLogger]:
    ...
    `logging.Logger.log` and `logplus.stdlib.BoundLogger.log`.

    Compared to using *logplus*'s standard library integration and the
    `logplus.stdlib.filter_by_level` processor:
