...
See also :doc:`logplus's Twisted support <twisted>`.
"""
...
class BoundLogger(BoundLoggerBase):
    """
    Twisted-specific version of `logplus.BoundLogger`.
    ...
    Use it like::
        ...
        configure(
            wrapper_class=logplus.twisted.BoundLogger,
        )
...
class LoggerFactory:
    ...
    >>> from logplus.twisted import LoggerFactory
...
class JSONRenderer(GenericJSONRenderer):
    """
    Behaves like `logplus.processors.JSONRenderer` except that it formats
...
def plainJSONStdOutLogger() -> JSONLogObserverWrapper:
    ...
    are outside of your control::
        ...
        $ twistd -n --logger logplus.twisted.plainJSONStdOutLogger web
...
class EventAdapter:
    ...
    Args:
        dictRenderer:
            ...
            logplus comes with a dedicated `JSONRenderer`.
