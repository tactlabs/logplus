...
class BoundLoggerBase:
    ...
    - `logplus.stdlib.BoundLogger`.
    - `logplus.twisted.BoundLogger`,
    ...
    def _process_event(
        ...
        Raises:
            logplus.DropEvent: if log entry should be dropped.
    ...
    def _proxy_to_logger(
        ...
        handling :exc:`logplus.DropEvent`, and finally calls *method_name* on
